...
- (IBAction)login_to_server:(id)sender {
    int ret = login_to_server([usernameTF.text UTF8String], [passwordTF.text UTF8String]);
    ...
    switch (ret) {
		...
		case LOGIN_WRONG_USERINPUT: {
			 ...
			 * server failed.
			 */
            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Incorrect usename or password"
                                                            message:@""
                                                           delegate:nil
